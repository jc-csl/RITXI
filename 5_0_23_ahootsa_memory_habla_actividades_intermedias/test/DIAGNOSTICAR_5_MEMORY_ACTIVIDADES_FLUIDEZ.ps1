...
# Ahootsa 5.0.23: comprueba cambios de Memory hablado y actividades intermedias.
...
Write-Host "============================================================"
Write-Host "Diagnóstico Ahootsa 5.0.23 Memory + actividades"
Write-Host "============================================================"
...
base = pathlib.Path(r"/mnt/data/5_0_23_ahootsa_memory_habla_actividades_intermedias") / "src" / "ahootsa_realtime_ollama_desktop_app"
print("base =", base)

...
(() => {
        ...
        ((t.localCName = t.generateIdentifier()),
          ...
          (t.parseRtpParameters = function (e) {
            ...
            for (let i = 3; i < r.length; i++) {
              ...
              if (s) {
                ...
                switch (
                  ...
                  (r.rtcpFeedback = t.matchPrefix(e, 'a=rtcp-fb:' + o + ' ').map(t.parseRtcpFb)),
                  n.codecs.push(r),
                  r.name.toUpperCase())
                ) {
                  case 'RED':
            ...
            return (
              n.codecs.forEach(e => {
                i.forEach(t => {
                  e.rtcpFeedback.find(e => e.type === t.type && e.parameter === t.parameter) ||
          ...
          (t.writeRtpDescription = function (e, n) {
            ...
            ((r += 'm=' + e + ' '),
              ...
              (r +=
                n.codecs
                  .map(e =>
                    void 0 !== e.preferredPayloadType ? e.preferredPayloadType : e.payloadType
                  )
                  .join(' ') + '\r\n'),
              (r += 'c=IN IP4 0.0.0.0\r\n'),
          ...
          (t.parseSctpDescription = function (e) {
            ...
            if (o.length > 0)
              return { port: parseInt(o[0].substring(12), 10), protocol: n.fmt, maxMessageSize: i };
  ...
  ((n.n = e => {
    ...
    (() => {
        ...
        !e.RTCIceCandidate ||
          ...
          c(e, 'icecandidate', e => {
            if (e.candidate) {
              ...
              'relay' === t.type &&
                (e.candidate.relayProtocol = { 0: 'tls', 1: 'tcp', 2: 'udp' }[t.priority >> 24]);
            }
            return e;
          });
      }
      ...
      !(function ({ window: n } = {}, o = { shimChrome: !0, shimFirefox: !0, shimSafari: !0 }) {
        const s = h,
          c = (function (e) {
        ...
        switch (c.browser) {
          case 'chrome':
            if (!e || !R || !o.shimChrome)
              return (s('Chrome shim is not included in this adapter release.'), p);
            if (null === c.version)
              return (s('Chrome shim can not determine version, not shimming.'), p);
          ...
          case 'firefox':
            if (!t || !O || !o.shimFirefox)
              return (s('Firefox shim is not included in this adapter release.'), p);
          ...
          case 'safari':
            if (!r || !o.shimSafari)
              return (s('Safari shim is not included in this adapter release.'), p);
      ...
      const se = Object.freeze({
        ...
        ae = { idle: 0, connecting: 1, streaming: 2, closed: 3 };
      Object.freeze(ae);
      const ce = ae;
      class de extends EventTarget {
        ...
        close() {
          this._state !== ce.closed &&
            (this._state !== ce.idle &&
              this._comChannel &&
              this._sessionId &&
              this._comChannel.send({ type: 'endSession', sessionId: this._sessionId }),
            (this._state = ce.closed),
      ...
      function me(e, t) {
        ...
        if (1 === e.length) {
          ...
          t in he && (n = he[t]);
        } else t in pe ? (n = pe[t]) : ue.has(t) && (n = t);
        return n;
      }
      const _e = Object.freeze([
        ...
        Ce = Object.freeze({ keydown: 'KeyPress', keyup: 'KeyRelease' });
      function ye(e) {
        const t = [];
        return (
      ...
      class ve extends EventTarget {
              ...
              if (this._rtcDataChannel === e) {
                ...
                this.dispatchEvent(
                  new ErrorEvent('error', {
                    ...
                    error: e || new Error('unknown error on the remote controller data channel'),
                  })
                );
              }
            }),
            e.addEventListener('message', e => {
              try {
                ...
                'ControlResponseMessage' === t.type
                  ? this.dispatchEvent(new CustomEvent('controlResponse', { detail: t }))
                  : 'InfoMessage' === t.type &&
        ...
        attachVideoElement(e) {
          if (e instanceof HTMLVideoElement && e !== this._videoElement) {
            ...
            for (const t of _e) e.addEventListener(t, this);
            ...
            (e.removeAttribute('tabindex'),
              ...
              (this._videoElementComputedStyle = null),
              (this._lastTouchEventTimestamp = 0));
            for (const t of _e) e.removeEventListener(t, this);
          }
        }
        sendControlRequest(e) {
          try {
            ...
            const t = { id: this._requestCounter++, request: e };
        ...
        _sendGstNavigationEvent(e) {
          const t = { type: 'navigationEvent', event: e };
        ...
        _computeVideoMousePosition(e) {
          ...
          ((s.x = Math.max(0.5 * (s.x - this._videoElement.videoWidth * a), 0)),
            (s.y = Math.max(0.5 * (s.y - this._videoElement.videoHeight * a), 0)));
          const c = 0 !== a ? 1 / a : 0;
          return (
            (t.x = (t.x - s.x) * c),
            (t.y = (t.y - s.y) * c),
          ...
          if (this._videoElement)
            switch (e.type) {
              ...
              case 'mouseup':
                ...
                {
                  const t = this._computeVideoMousePosition(e),
                    n = { event: fe[e.type], x: t.x, y: t.y, modifier_state: ye(e) };
                  ('mousemove' !== e.type &&
                    ((n.button = e.button + 1),
                    'mousedown' === e.type && 0 === e.button && this._videoElement.focus()),
              ...
              case 'touchcancel':
                ...
                e.timeStamp > this._lastTouchEventTimestamp &&
                  ...
                  this._sendGstNavigationEvent({ event: 'TouchFrame', modifier_state: ye(e) }));
                break;
              case 'keyup':
              case 'keydown':
                e.preventDefault();
                {
                  const t = { event: Ce[e.type], key: me(e.key, e.code), modifier_state: ye(e) };
      ...
      const Se = class extends le {
              ...
              this._rtcPeerConnection
                ...
                .then(() => {
                  if (this._rtcPeerConnection && this._comChannel) {
                    ...
                    ((this._state = ce.connecting), this.dispatchEvent(new Event('stateChanged')));
                  }
                })
                .catch(e => {
                  this._state !== ce.closed &&
        ...
        onSessionStarted(e, t) {
          if (this._peerId === e && this._state === ce.connecting && !this._sessionId) {
            (console.log('Session started', this._sessionId), (this._sessionId = t));
              ...
              (e.ontrack = t => {
                if (this._rtcPeerConnection === e && t.streams && t.streams.length > 0) {
                  this._state === ce.connecting &&
                    ((this._state = ce.streaming), this.dispatchEvent(new Event('stateChanged')));
                  let e = !1;
                  for (const n of t.streams)
                    this._streams.includes(n) || (this._streams.push(n), (e = !0));
        ...
        mungeStereo(e, t) {
          ...
          for (const e of r) {
            ...
            t.match(n) || (t = t.replaceAll('a=fmtp:' + e, 'a=fmtp:' + e + ' stereo=1;'));
          }
          return t;
        }
            ...
            if ((this.ensurePeerConnection(), e.sdp))
              this._offerOptions
                ...
                : this._rtcPeerConnection
                    .setRemoteDescription(e.sdp)
                    .then(() =>
                      this._rtcPeerConnection ? this._rtcPeerConnection.createAnswer() : null
                    )
                    .then(t =>
                      this._rtcPeerConnection && t
                        ? (this._mungeStereoHack && (t.sdp = this.mungeStereo(e.sdp.sdp, t.sdp)),
                ...
                );
              {
                ...
                this._rtcPeerConnection.addIceCandidate(t).catch(e => {
                  if (this._state === ce.closed) return;
                  if (
                    this._rtcPeerConnection &&
                    (this._rtcPeerConnection.iceConnectionState === 'connected' ||
                      this._rtcPeerConnection.iceConnectionState === 'completed')
                  ) {
                    console.warn(
                      '[GstWebRTC] Ignoring late ICE candidate error (connection already established):',
                      e.message
                    );
                    return;
                  }
      ...
      class Te extends EventTarget {
        ...
        start() {
          ...
          return this._comChannel.send(e)
            ? ((this._state = ce.connecting), this.dispatchEvent(new Event('stateChanged')), !0)
            : (this.dispatchEvent(
                new ErrorEvent('error', {
        ...
        onStartSessionMessage(e) {
          if (this._comChannel && this._stream && !(e.sessionId in this._clientSessions)) {
            const t = new ke(e.peerId, e.sessionId, this._comChannel, this._stream);
            ((this._clientSessions[e.sessionId] = t),
              t.addEventListener('closed', e => {
                ...
                n in this._clientSessions &&
                  ...
                  this.dispatchEvent(new CustomEvent('clientConsumerRemoved', { detail: t })));
              }),
      ...
      class we extends EventTarget {
                ...
                if (n && 'object' == typeof n)
                  switch (n.type) {
                    case Pe.welcome:
                      ...
                      try {
                        this._ws.send(
                          JSON.stringify({ type: 'setPeerStatus', roles: ['listener'], meta: t })
                        );
                      } catch (e) {
                        (this.dispatchEvent(
                          new ErrorEvent('error', {
                    ...
                    case Pe.peerStatusChanged:
                      if (n.peerId === this._channelId)
                        ...
                        const e = Re(n, this._channelId);
                        e &&
                          (n.roles.includes('producer')
                            ? this.dispatchEvent(new CustomEvent('producerAdded', { detail: e }))
                            : this.dispatchEvent(
                                new CustomEvent('producerRemoved', { detail: e })
                              ));
                      }
                      break;
                    case Pe.list:
                      for (const e of n.producers) {
                        const t = Re(e, this._channelId);
                        t && this.dispatchEvent(new CustomEvent('producerAdded', { detail: t }));
                      }
                      break;
                    case Pe.sessionStarted:
                      {
                        const e = this.getConsumerSession(n.peerId);
                        e &&
                          (delete this._consumerSessions[n.peerId],
                          e.onSessionStarted(n.peerId, n.sessionId),
                          e.sessionId && !(e.sessionId in this._consumerSessions)
                    ...
                    case Pe.peer:
                      {
                        ...
                        e
                          ...
                          : this._producerSession && this._producerSession.onSessionPeerMessage(n);
                      }
                      break;
                    case Pe.startSession:
                    ...
                    case Pe.endSession:
                      {
                        ...
                        e
                          ? e.close()
                          : this._producerSession && this._producerSession.onEndSessionMessage(n);
                      }
                      break;
                    case Pe.error:
                      this.dispatchEvent(
        ...
        createProducerSession(e) {
          ...
          if (this._producerSession)
            return this._producerSession.stream === e ? this._producerSession : null;
      ...
      class xe {
        ...
        registerConnectionListener(e) {
          return (
            ...
            ) && (this._connectionListeners.includes(e) || this._connectionListeners.push(e), !0)
          );
        }
        ...
        registerProducersListener(e) {
          return (
            ...
            ) && (this._producersListeners.includes(e) || this._producersListeners.push(e), !0)
          );
        }
        ...
        createConsumerSessionWithOfferOptions(e, t) {
          return this._channel ? this._channel.createConsumerSession(e, t) : null;
        }
        connectChannel() {
          if (this._channel) {
          ...
          ((this._channel = new Ae(
            ...
            this._channel.addEventListener('ready', e => {
              e.target === this._channel && this.triggerConnected(this._channel.channelId);
            }),
            ...
            this._channel.addEventListener('producerRemoved', e => {
              e.target === this._channel && this.triggerProducerRemoved(e.detail.id);
            }));
        }
        triggerConnected(e) {
      ...
      xe.SessionState = ce;
      const Ie = xe;
      window.GstWebRTCAPI || (window.GstWebRTCAPI = Ie);
    })());
})();

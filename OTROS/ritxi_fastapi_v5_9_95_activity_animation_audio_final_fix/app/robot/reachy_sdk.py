"""
v5.9.61 · Adaptador Reachy Mini

Cliente de robot/simulador:
- conecta con Reachy Mini daemon o simulación;
- ejecuta movimientos oficiales y posturas;
- controla neutralidad/idle;
- registra errores de conexión o movimiento.

Regla importante:
Los comandos de robot son opcionales. El modo Texto + IA debe funcionar aunque no haya robot.
"""

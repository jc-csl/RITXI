...
class ConversationMemory:
    ...
    def messages_for(self, session_id: str, user_text: str) -> list[dict[str, str]]:
        """Construye el prompt de un turno conversacional.

        v5.9.82: por defecto no se arrastra historial en el chat libre.
        Con modelos muy pequeños como qwen3:0.6b, incluso 1-2 turnos de historial
        provocaban respuestas pegadas al tema anterior. Las actividades ya envían
        su propio contexto explícito en el texto cuando lo necesitan.
        """
        ...
        topic_guard = (
            "Instrucción prioritaria del turno: responde SOLO al último mensaje del usuario. "
            "No copies ejemplos del prompt. No reutilices respuestas anteriores. "
            "Si el usuario cambia de tema, cambia tú también de tema."
        )
        return [

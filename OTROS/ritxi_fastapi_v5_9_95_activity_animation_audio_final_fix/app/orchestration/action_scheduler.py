"""
v5.9.61 · Planificador de acciones

Coordina acciones de habla, emoción, espera activa y controles manuales:
- ordena acciones por prioridad;
- evita solapes de movimientos;
- controla movimiento reactivo al habla;
- mantiene idle/espera activa cuando procede.

Regla importante:
El robot puede tardar más que la IA. Las acciones largas no deben bloquear la entrada de texto.
"""

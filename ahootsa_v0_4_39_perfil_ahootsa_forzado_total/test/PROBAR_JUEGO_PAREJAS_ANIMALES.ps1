...
# Ejecutar desde la raíz con: powershell -ExecutionPolicy Bypass -File .\test\PROBAR_JUEGO_PAREJAS_ANIMALES.ps1
...
if (-not (Test-Path $ServerPy)) { Fail "No existe memory_pairs_game_server.py. Instala primero v0.4.39." }

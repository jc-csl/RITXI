...
$Out = Join-Path $LogRoot "AHOOTSA_COMUNICACION_DIAGNOSTICO_7_0_22_$Stamp.log"
...
Add-Line "Ahootsa diagnostico comunicacion 7.0.22 - 3 niveles"
Add-Line "Fecha: $(Get-Date -Format o)"
Add-Line "BaseUrl: $BaseUrl"
Add-Line "Level: $Level"
Add-Line "Activity: $Activity"
Add-Line "Nota: estas pruebas NO llaman a Ollama. Actividades: saludar, pedir comida, mantener turnos y conversar en nivel facil/intermedio/avanzado. Si son rapidas y la voz tarda, el retraso esta en la cadena voz/HF."
...
Test-Endpoint "Listar actividades" "$BaseUrl/communication/activities?level=$([uri]::EscapeDataString($Level))&limit=4" | Out-Null

...
$Out = Join-Path $LogRoot "AHOOTSA_DIAGNOSTICO_GENERAL_7_0_22_$Stamp.log"
$Py = "$env:LOCALAPPDATA\Reachy Mini Control\apps_venv\Scripts\python.exe"
"Ahootsa diagnóstico general 7.0.22" | Set-Content -Encoding UTF8 $Out
...
'@
$Tmp = Join-Path $env:TEMP "ahootsa_diag_general_7_0_22.py"

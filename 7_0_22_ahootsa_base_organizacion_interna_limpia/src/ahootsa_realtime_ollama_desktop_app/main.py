"""Ahootsa 7.0.22: extensión instalable de Reachy Mini Conversation App.

7.0.22 mejora diagnóstico en Windows, aliases de voz y reglas de selección de herramientas para bailes, emociones y Memory.

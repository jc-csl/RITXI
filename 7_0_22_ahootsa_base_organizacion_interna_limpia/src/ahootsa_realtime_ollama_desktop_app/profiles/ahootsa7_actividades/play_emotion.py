...
def _repair_mojibake(text: str) -> str:
    """Repair common one-step or double-step UTF-8 mojibake.

    Examples: "elÃ©ctrico" and "elÃƒÂ©ctrico" -> "eléctrico".
    Windows logs can double-encode accents, so we try a few repair passes.
    """
    ...
    for _ in range(3):
        ...
        for enc in ("latin-1", "cp1252"):
            try:
                repaired = current.encode(enc, errors="strict").decode("utf-8", errors="strict")
...
def _spanish_resource_maps() -> dict[str, dict[str, str]]:
    ...
    builtin = {
        ...
        "baile numero dos": "dance2", "baile número dos": "dance2", "baile nÃºmero dos": "dance2", "baile nÃƒÂºmero dos": "dance2", "baile n2": "dance2", "numero dos": "dance2", "número dos": "dance2", "dos": "dance2",
        ...
        "baile numero tres": "dance3", "baile número tres": "dance3", "baile nÃºmero tres": "dance3", "baile nÃƒÂºmero tres": "dance3", "baile n3": "dance3", "numero tres": "dance3", "número tres": "dance3", "tres": "dance3",
        ...
        "celebracion": "success1", "celebración": "success1", "celebraciÃ³n": "success1", "celebraciÃƒÂ³n": "success1", "celebra": "success1", "aplauso": "success1", "bravo": "success1",
        "calma": "calming1", "tranquila": "calming1", "tranquilo": "calming1", "relajate": "calming1", "relájate": "calming1",
        "pensar": "thoughtful1", "piensa": "thoughtful1", "sorpresa": "amazed1", "asombro": "amazed1", "electrico": "electric1", "eléctrico": "electric1", "elÃ©ctrico": "electric1", "elÃƒÂ©ctrico": "electric1", "electrico uno": "electric1", "eléctrico uno": "electric1",
...
def resolve_emotion_name(requested_emotion: object) -> str | None:
    ...
    # Ahootsa 7.0.22: reglas tempranas para errores de voz frecuentes.
    ...
    if ("uno" in tokens or "1" in tokens or "primer" in tokens or "primero" in tokens or requested in {"play", "olay", "ole", "olé"}) and (tokens & {"baile", "baila", "danza", "play", "olay", "ole", "olé"} or requested in {"play", "olay", "ole", "olé"}):
        if "dance1" in available:
            return "dance1"
    if requested in {"electrico", "eléctrico", "elÃ©ctrico", "elÃƒÂ©ctrico", "electric", "algo_electrico", "algo_elÃ©ctrico", "algo_elÃƒÂ©ctrico"}:
...
class PlayEmotion(Tool):
    ...
    description = (
        ...
        "In Ahootsa 7.0.22 the audio uses a reinforced pygame/SDL backend with driver fallback and persistent Sound references."
    )

...
$out=Join-Path $LogRoot "ULTIMA_EJECUCION_AHOOTSA_5_0_39_RESUMEN.log"
...
"Resumen Ahootsa 5.0.39 generado: $(Get-Date -Format o)" | Set-Content -LiteralPath $out -Encoding UTF8

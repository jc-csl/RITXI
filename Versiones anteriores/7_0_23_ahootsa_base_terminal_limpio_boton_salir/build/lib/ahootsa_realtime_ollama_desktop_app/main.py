"""Ahootsa 7.0.23: extensión instalable de Reachy Mini Conversation App.

7.0.23 reduce el ruido de terminal de /memory/state, añade botón Salir en el panel y mantiene la base 7.0.22 ordenada.
...
class AhootsaRealtimeOllamaApp(ReachyMiniApp):  # type: ignore[misc]
    ...
    def run(self, reachy_mini: ReachyMini, stop_event: threading.Event) -> None:
        ...
        try:
            ...
            mount_ahootsa_routes(self.settings_app, reachy_mini=reachy_mini, stop_event=stop_event)

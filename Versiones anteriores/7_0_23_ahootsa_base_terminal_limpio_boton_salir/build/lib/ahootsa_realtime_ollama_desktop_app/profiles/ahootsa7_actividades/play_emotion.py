...
def resolve_emotion_name(requested_emotion: object) -> str | None:
    ...
    # Ahootsa 7.0.23: reglas tempranas para errores de voz frecuentes.
...
class PlayEmotion(Tool):
    ...
    description = (
        ...
        "In Ahootsa 7.0.23 the audio uses a reinforced pygame/SDL backend with driver fallback and persistent Sound references."
    )

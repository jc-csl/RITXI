...
def _ahootsa_persona_prefix() -> str:
    try:
        p = data_path("communication", "communication_profile.md")
        if p.exists():
...
class AskOllamaTool(Tool):
    ...
    parameters_schema = {
        ...
        "properties": {
            ...
            "model": {
                "type": "string",
                "description": "Modelo Ollama opcional. Por defecto usa OLLAMA_MODEL o llama3.2:3b.",
            },
        },
        "required": ["prompt"],
    }
        ...
        **_: Any,
        ...
        try:
            ...
            msg = (
                ...
                "Comprueba que Ollama esté abierto y que el modelo configurado exista, por defecto llama3.2:3b."
            )

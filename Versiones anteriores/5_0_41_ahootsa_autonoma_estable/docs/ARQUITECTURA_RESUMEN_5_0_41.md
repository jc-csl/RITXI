# Arquitectura resumida 5.0.41

- Carpeta local de control: `D:\RITXI\5_0_41_ahootsa_autonoma_estable`.
...
La 5.0.41 no necesita carpetas antiguas porque no copia de ellas. Parchea directamente el paquete instalado en `apps_venv` y lanza desde su propia carpeta.

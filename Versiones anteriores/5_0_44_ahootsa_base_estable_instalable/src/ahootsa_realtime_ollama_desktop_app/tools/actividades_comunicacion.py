...
class ActividadesComunicacion(Tool):
    ...
    parameters_schema = {
        ...
        "properties": {
            ...
            "nivel": {
                "type": "string",
                "description": "facil, intermedia o avanzada.",
                "default": ""
            },
            "actividad": {
                "type": "string",
    ...
    async def __call__(self, deps: ToolDependencies, **kwargs: Any) -> dict[str, Any]:
        ...
        if accion == "niveles":
            ...
            result = {"ok": True, "accion": "niveles", "available_levels": ["facil", "intermedia", "avanzada"], "router": True}
        ...
        if accion == "listar":
            if nivel not in levels:
                message = _format_levels()
                result = {"ok": False, "accion": "listar", "error": "missing_or_unknown_level", "available_levels": ["facil", "intermedia", "avanzada"], "router": True}
                _direct(result, message)
        ...
        # iniciar
        if nivel not in levels:
            message = "Para iniciar una actividad, dime primero el nivel: fácil, intermedia o avanzada."

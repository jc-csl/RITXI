...
Write-Host "============================================================"
Write-Host "Diagnóstico bailes/emociones Ahootsa 7.0.14"
Write-Host "============================================================"
...
for text in ['baile uno','baile dos','baile tres','celebración','saludo','calma','eléctrico','dance1','dance2','dance3']:

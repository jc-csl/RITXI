# Ahootsa 5_0 — modo MuJoCo web sin Reachy Mini Desktop

## Objetivo

Lanzar Ahootsa y visualizar/mover el robot en MuJoCo 3D sin abrir Reachy Mini Desktop.

## Por qué

En las pruebas, el daemon MuJoCo funciona correctamente, pero Reachy Mini Desktop puede tomar el control del ciclo de vida del daemon y cerrarlo. Por eso esta versión usa directamente el panel web del daemon.
...
Reachy Mini daemon --sim
   ...
   |
   +--> API REST /api/apps/start-app/ahootsa_realtime_ollama_app
          |
          v
       Ahootsa
```

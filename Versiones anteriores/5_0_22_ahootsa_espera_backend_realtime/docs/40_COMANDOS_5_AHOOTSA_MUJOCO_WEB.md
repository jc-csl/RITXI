# Comandos Ahootsa 5_0

## Instalar/copiar perfil

```powershell
cd D:\RITXI\5_0_ahootsa_mujoco_web_sin_desktop
...
## Lanzar sin arrancar automáticamente la app

```powershell
powershell -ExecutionPolicy Bypass -File .\LANZAR_5_AHOOTSA_MUJOCO_WEB.ps1 -NoStartApp
```

## Parar solo la app

```powershell
powershell -ExecutionPolicy Bypass -File .\PARAR_5_AHOOTSA_MUJOCO_WEB.ps1
```

## Parar app y daemon

```powershell
powershell -ExecutionPolicy Bypass -File .\PARAR_5_AHOOTSA_MUJOCO_WEB.ps1 -StopDaemon
```

...
REVEAL_SECONDS = float(os.getenv("AHOOTSA_MEMORY_REVEAL_SECONDS", "4"))
# 7.0.11: sin retardo visual oculto. Al elegir cartas, la imagen aparece
# inmediatamente en el iframe; no se mantiene el número ni se ve invertido.
    ...
    def _cleanup_revealed_if_needed(self) -> None:
        if self.revealed_numbers and self.reveal_until and _now() >= self.reveal_until:
            ...
            if self.last_result == "miss":
                self.message = "Prueba con otros dos números. Vas bien."
        ...
        with self.lock:
            ...
            if (
                ...
                return {
                    ...
                    "result": "repeat_miss",
                    "matched": False,
                    "message_for_user": "Esas cartas ya están visibles. Míralas con calma.",
                    "robot_say": "",
            ...
            # 7.0.11: las cartas se muestran de inmediato en el iframe. En
            ...
            if FLIP_DELAY_SECONDS > 0:
                self.pending_visual_numbers = {c1["number"], c2["number"]}
                self.pending_visual_until = _now() + FLIP_DELAY_SECONDS
            else:
                self.pending_visual_numbers = set()
                self.pending_visual_until = 0.0
            ...
            self.last_result = "miss"
            self.last_animation = "💪"
            self.message = f"Casi, no son pareja: {c1['label']} y {c2['label']}. Buen intento. Prueba con otros dos números."
    ...
    def public_state(self) -> dict[str, Any]:
        with self.lock:
            ...
            return {
                ...
                "flip_delay_seconds": FLIP_DELAY_SECONDS,

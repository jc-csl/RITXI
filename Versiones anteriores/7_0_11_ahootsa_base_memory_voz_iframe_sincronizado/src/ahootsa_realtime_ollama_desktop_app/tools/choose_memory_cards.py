    ...
    async def __call__(self, deps: ToolDependencies, **kwargs: Any) -> dict[str, Any]:
        ...
        try:
            ...
            if (
                ...
                message = "Esas cartas ya están visibles. Míralas con calma y elige otros dos números."
                duplicate = {
                    "ok": True,
            ...
            # 7.0.11: no decir "Vamos a ver..." porque la imagen ya está visible
            ...
            if raw_result == "repeat_miss":
                ...
                reaction_kind = "miss"
                message = "Casi, no son pareja. Buen intento. Prueba con otros dos números."
            elif raw.get("ok"):
                reaction_kind = "invalid"
                message = "Mira las cartas con calma y elige dos números del 1 al 8."
            else:
                reaction_kind = "invalid"

...
def _spanish_resource_maps() -> dict[str, dict[str, str]]:
    ...
    try:
        ...
        pass
    builtin = {
        "baile": "dance1", "baila": "dance1", "danza": "dance1", "fiesta": "dance1",
        "baile uno": "dance1", "baile 1": "dance1", "primer baile": "dance1", "baile alegre": "dance1", "baile alegre uno": "dance1",
        "baile dos": "dance2", "baile 2": "dance2", "segundo baile": "dance2", "baile animado": "dance2", "baile animado dos": "dance2",
        "baile numero dos": "dance2", "baile número dos": "dance2", "baile n2": "dance2", "numero dos": "dance2", "número dos": "dance2", "dos": "dance2",
        "baile tres": "dance3", "baile 3": "dance3", "tercer baile": "dance3", "baile energia": "dance3", "baile energía": "dance3", "baile con energia": "dance3", "baile con energía": "dance3",
        "baile numero tres": "dance3", "baile número tres": "dance3", "baile n3": "dance3", "numero tres": "dance3", "número tres": "dance3", "tres": "dance3",
        ...
        "celebracion": "success1", "celebración": "success1", "celebra": "success1", "aplauso": "success1", "bravo": "success1",
        "calma": "calming1", "tranquila": "calming1", "tranquilo": "calming1", "relajate": "calming1", "relájate": "calming1",
        "pensar": "thoughtful1", "piensa": "thoughtful1", "sorpresa": "amazed1", "asombro": "amazed1", "electrico": "electric1", "eléctrico": "electric1",
...
def resolve_emotion_name(requested_emotion: object) -> str | None:
    ...
    if {"yes", "understanding"}.issubset(tokens):
        for candidate in INTENT_TO_MOVES["yes_understanding"]:
            if candidate in available:
                return candidate
    for alias, technical in alias_map.items():
        if technical in available and alias and (alias in requested or requested in alias):
            return technical
    return None

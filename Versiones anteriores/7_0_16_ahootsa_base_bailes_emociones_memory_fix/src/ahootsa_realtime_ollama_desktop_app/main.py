"""Ahootsa 7.0.16: extensión instalable de Reachy Mini Conversation App.

7.0.16 mejora bailes y emociones: nombres en español, aliases robustos y diagnóstico de recursos disponibles.

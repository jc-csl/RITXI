"""Ahootsa 7.0.15: extensión instalable de Reachy Mini Conversation App.

7.0.15 mejora bailes y emociones: nombres en español, aliases robustos y diagnóstico de recursos disponibles.

    ...
    async def __call__(self, deps: ToolDependencies, **kwargs: Any) -> dict[str, Any]:
        ...
        try:
            ...
            if isinstance(result, dict):
                # 7.0.10: el baile puede ejecutarse en MuJoCo aunque el backend emita
                # avisos IK. Si el movimiento fue encolado, se considera correcto con
                # advertencias, no fallo de actividad.

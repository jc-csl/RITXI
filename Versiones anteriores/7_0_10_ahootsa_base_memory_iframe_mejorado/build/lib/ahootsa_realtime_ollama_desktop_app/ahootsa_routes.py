...
"""Ahootsa 7.0.10 panel/API routes.
...
<div class='header'><strong>Ahootsa <b>7.0.10</b></strong><span>Conversación principal: Hugging Face Realtime oficial · Ollama auxiliar: {_ollama_model()}</span></div>
...
<iframe id='memoryFrame' style='width:100%;height:560px;border:1px solid #d7dbea;border-radius:12px;background:#eef2f7'></iframe><div class='small'><a href='/memory/page?game_id=animales&reset=1' target='_blank'>Abrir juego en pantalla grande</a></div>
</div>

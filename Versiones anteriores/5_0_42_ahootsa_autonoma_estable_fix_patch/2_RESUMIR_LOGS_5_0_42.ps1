...
$Out = Join-Path $LogRoot "ULTIMA_EJECUCION_AHOOTSA_5_0_42_RESUMEN.txt"
"Resumen Ahootsa 5.0.42 - generado $(Get-Date -Format o)" | Set-Content -Encoding UTF8 -LiteralPath $Out

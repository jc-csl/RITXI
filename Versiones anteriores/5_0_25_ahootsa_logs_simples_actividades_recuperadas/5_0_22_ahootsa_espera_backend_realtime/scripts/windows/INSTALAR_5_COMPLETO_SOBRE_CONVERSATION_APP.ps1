...
# Ahootsa 5.0.22 - instalacion completa sobre reachy_mini_conversation_app.
...
function Copy-Profile([string]$Target) {
    ...
    "Ahootsa 5.0.22 full install $(Get-Date -Format o)" | Set-Content -Encoding UTF8 -LiteralPath (Join-Path $Target ".ahootsa_5_0_9_full_install.txt")
    ...
    if ($Txt -notmatch "MODO CONVERSACIONAL 5.0.22") {
        Add-Content -Encoding UTF8 -LiteralPath $Instructions -Value @(
            "",
            "## MODO CONVERSACIONAL 5.0.22 - APP OFICIAL COMPLETA",
...
Write-Host ""
Write-Host "============================================================"
Write-Host "Ahootsa 5.0.22 - instalacion completa sobre conversation app"
Write-Host "============================================================"

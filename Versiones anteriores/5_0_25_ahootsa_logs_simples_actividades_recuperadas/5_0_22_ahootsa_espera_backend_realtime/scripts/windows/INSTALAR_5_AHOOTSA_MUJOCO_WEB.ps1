...
function Copy-ProfileSafe([string]$Target) {
    ...
    "Ahootsa 5.0.22 profile copy $(Get-Date -Format o)" | Set-Content -Encoding UTF8 -LiteralPath (Join-Path $Target ".ahootsa_5_0_6_profile_forced.txt")
...
Write-Step "Instalando Ahootsa 5.0.22"

# Índice documentación Ahootsa 5_0

Esta carpeta `/doc` es una copia actualizada de `/docs`.

## Documentos principales para esta versión

1. `39_MODO_MUJOCO_WEB_SIN_DESKTOP_5_0.md`
2. `40_COMANDOS_5_AHOOTSA_MUJOCO_WEB.md`
3. `41_API_REST_USADA_5_AHOOTSA_MUJOCO_WEB.md`
4. `42_NO_USAR_DESKTOP_EN_MODO_MUJOCO_WEB.md`
5. `43_CHANGELOG_5_0.md`

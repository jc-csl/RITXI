...
- Script maestro `LANZAR_5_AHOOTSA_MUJOCO_WEB.ps1`.
- Script de parada `PARAR_5_AHOOTSA_MUJOCO_WEB.ps1`.
- Script de instalación/copia de perfil `INSTALAR_5_AHOOTSA_MUJOCO_WEB.ps1`.
- Diagnóstico `test/DIAGNOSTICAR_5_AHOOTSA_MUJOCO_WEB.ps1`.
- Carpeta `/doc` duplicada desde `/docs` para facilitar entrega.
- Documentación específica de MuJoCo web sin Desktop.
...
- Memory.
- Voz Sohee.
- Router de actividades v0.4.57.9.

## Recomendación

Usar `ahootsa_realtime_ollama_app` ON y `reachy_mini_conversation_app` OFF.

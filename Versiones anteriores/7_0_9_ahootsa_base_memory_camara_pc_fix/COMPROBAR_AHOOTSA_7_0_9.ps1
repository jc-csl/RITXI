...
try {
    Write-Host "============================================================"
    Write-Host "Diagnóstico Ahootsa 7.0.9"
    Write-Host "============================================================"
    ...
    if (Test-Path $Py) {
        $TmpPy = Join-Path $env:TEMP 'ahootsa_diag_imports_7_0_9.py'
@'
...
try {
    ...
    Write-Host "[WARN] No responde /config/list. Arranca primero LANZAR_AHOOTSA_7_0_9.ps1 si quieres probar el panel."

...
```powershell
powershell -ExecutionPolicy Bypass -File .\LANZAR_AHOOTSA_HF_LOCAL_5_0_40.ps1 -HFModelPath "D:\RITXI\models\TU_MODELO"
```

## Por qué se corrige el error anterior

La 5.0.38 intentaba borrar la misma carpeta desde la que se ejecutaba cuando se usaba `-Force`. La 5.0.40 usa una carpeta destino distinta:

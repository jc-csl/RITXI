"""Ahootsa 7.0.13: extensión instalable de Reachy Mini Conversation App.

7.0.13 corrige falsos fallos en bailes/emociones cuando MuJoCo muestra avisos IK pero el movimiento se ejecuta.

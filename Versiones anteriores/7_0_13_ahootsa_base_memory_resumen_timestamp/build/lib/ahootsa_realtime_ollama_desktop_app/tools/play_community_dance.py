    ...
    async def __call__(self, deps: ToolDependencies, **kwargs: Any) -> dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "message_for_user": f"He hecho el dance {move_name}.",
            }
            ...
            if "collision" in lowered or "not achievable" in lowered or "ik error" in lowered:
                return {
                    ...
                    "message_for_user": f"He hecho el dance {move_name}. MuJoCo ha mostrado un aviso IK, pero no lo trato como fallo si se ha visto el movimiento.",
                }
            return {
                "ok": False,
                "dance": move_name,

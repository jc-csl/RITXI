...
# Ahootsa 5.0.34 - instalacion completa sobre reachy_mini_conversation_app.
...
function Copy-Profile([string]$Target) {
    ...
    "Ahootsa 5.0.34 full install $(Get-Date -Format o)" | Set-Content -Encoding UTF8 -LiteralPath (Join-Path $Target ".ahootsa_5_0_9_full_install.txt")
...
Write-Host ""
Write-Host "============================================================"
Write-Host "Ahootsa 5.0.34 - instalacion completa sobre conversation app"
Write-Host "============================================================"

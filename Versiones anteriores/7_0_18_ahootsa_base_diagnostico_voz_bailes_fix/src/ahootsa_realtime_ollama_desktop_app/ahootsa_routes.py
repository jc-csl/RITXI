...
"""Ahootsa 7.0.18 panel/API routes.
...
<div class='header'><strong>Ahootsa <b>7.0.18</b></strong><span>Conversación principal: Hugging Face Realtime oficial · Ollama auxiliar: {_ollama_model()}</span></div>

...
if (-not $HtmlSource) {
    Fail "No encuentro memory_pairs_animales.html en esta carpeta v0.4.44."
}
...
Write-Host "powershell -ExecutionPolicy Bypass -File .\test\PROBAR_JUEGO_PAREJAS_ANIMALES.ps1"

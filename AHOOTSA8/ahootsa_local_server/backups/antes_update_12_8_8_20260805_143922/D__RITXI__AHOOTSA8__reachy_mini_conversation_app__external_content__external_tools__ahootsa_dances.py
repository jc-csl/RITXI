...
Version 1.4 keeps the shared-audio and microphone-preservation fixes and
...
class PlayAhootsaDance(Tool):
    ...
    description = (
        ...
        "inactivity. This tool remains active until the selected dance ends. "
        "When it returns status completed, continue the conversation with "
        "one brief positive sentence and one simple question."
    )
    needs_response = True
    parameters_schema = {
        "type": "object",

...
$env:REACHY_MINI_CUSTOM_PROFILE = 'ahootsa_session_000003'
...
$env:AHOOTSA_SESSION_ID = '3'
$env:AHOOTSA_SESSION_CONTEXT_FILE = 'D:\RITXI\AHOOTSA8\runtime\sessions\session_000003\session_context.json'
...
Write-Host 'Sesión: 3' -ForegroundColor Gray
Write-Host 'Perfil: ahootsa_session_000003' -ForegroundColor Gray
Write-Host 'Contexto: D:\RITXI\AHOOTSA8\runtime\sessions\session_000003\session_context.json' -ForegroundColor Gray
Write-Host ''

...
**Commit de referencia:** `d44fc7191e34fd293e37d45f8a84b5a986e38a58`  
...
| Elemento | Función |
|---|---|
| `.git` | Historial del repositorio oficial. |
...
Instalar Git para Windows desde su instalador oficial o mediante `winget`:
...
### 5.4. Instalar Python 3.12 mediante `uv`
...
## 6. Obtener la aplicación oficial

Hay dos rutas posibles. Para reproducir exactamente esta documentación se recomienda utilizar el ZIP o commit de referencia.

### Opción A — Copiar el ZIP oficial de referencia
...
### Opción B — Clonar el repositorio oficial
...
Para reproducir exactamente la versión documentada:

```powershell
git checkout d44fc7191e34fd293e37d45f8a84b5a986e38a58
```
...
```text
d44fc7191e34fd293e37d45f8a84b5a986e38a58
```
...
## 12. Prueba funcional de la Fase 0
...
### 12.5. Prueba sin cámara, solo para diagnóstico
...
## 13. Comprobaciones finales de la Fase 0
...
Los cambios esperados son únicamente:
...
## 17. Archivos modificados en esta fase
...
- Repositorio oficial `pollen-robotics/reachy_mini_conversation_app`.
- Repositorio oficial `pollen-robotics/reachy_mini`.

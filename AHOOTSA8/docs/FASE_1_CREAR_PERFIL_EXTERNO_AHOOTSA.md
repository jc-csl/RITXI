...
## 20. Comprobación de cambios en Git
...
Según la configuración de `.gitignore`, `.env` puede no mostrarse. También seguirán apareciendo los cambios de la Fase 0:
...
No deben aparecer modificaciones dentro de:
...
## 24. Referencias de la aplicación oficial
...
## 25. Mejoras incorporadas en la revisión 1.1

"""Ahootsa 7.0.20: extensión instalable de Reachy Mini Conversation App.

7.0.20 mejora diagnóstico en Windows, aliases de voz y reglas de selección de herramientas para bailes, emociones y Memory.
...
class AhootsaRealtimeOllamaApp(ReachyMiniApp):  # type: ignore[misc]
    ...
    def run(self, reachy_mini: ReachyMini, stop_event: threading.Event) -> None:
        ...
        try:
            ...
            mount_ahootsa_routes(self.settings_app, reachy_mini=reachy_mini)

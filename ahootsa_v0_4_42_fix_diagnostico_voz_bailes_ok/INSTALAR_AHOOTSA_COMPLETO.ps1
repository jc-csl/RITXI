...
Header "Ahootsa Realtime Ollama v0.4.42 - instalacion forzada"
...
Header "Configurar recordatorio de presencia"
powershell -ExecutionPolicy Bypass -File (Join-Path $Root "CONFIGURAR_RECORDATORIO_IDLE_AHOOTSA.ps1") -Seconds 20 -RepeatSeconds 60

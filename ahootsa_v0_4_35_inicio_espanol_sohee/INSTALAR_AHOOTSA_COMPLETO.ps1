...
Header "Ahootsa Realtime Ollama v0.4.35 - instalacion forzada"
...
powershell -ExecutionPolicy Bypass -File (Join-Path $Root "DIAGNOSTICAR_EMOCIONES_AUDIO.ps1")
...
powershell -ExecutionPolicy Bypass -File (Join-Path $Root "DIAGNOSTICAR_JUEGO_PAREJAS_ANIMALES.ps1")
...
powershell -ExecutionPolicy Bypass -File (Join-Path $Root "DIAGNOSTICAR_JUEGOS_PAREJAS_JSON.ps1")

...
Corrige el inicio en inglés y la voz por defecto:

```text
- Sohee por defecto.
- Saludo inicial en castellano: ¡Hola! Soy Ahootsa...
- Script FORZAR_INICIO_CASTELLANO_SOHEE.ps1 para evitar el greeting inglés del perfil default oficial.
```
...
# Ahootsa Realtime Ollama v0.4.35
...
## v0.4.35 — Integración en Desktop
...
## v0.4.35 — Cámara PC en simulación
...
## v0.4.35 — Reparar panel integrado de Desktop
...
## v0.4.35 — Emociones con sonido y movimiento
...
## v0.4.35 — Corrección HTML del juego
...
La versión v0.4.35 instala el HTML también dentro del perfil Ahootsa.


## v0.4.35 — Motor JSON de juegos de parejas
...
## v0.4.35 — Juegos visuales simples
...
## v0.4.35 — Memory visual con ritmo del robot

```text
- Dorso azul.
- Número blanco grande.
- Solo cartas en pantalla.
- Si no acierta, las cartas quedan visibles 4 segundos.

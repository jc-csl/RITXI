...
def _load_play_timing_config() -> dict[str, Any]:
    try:
        path = config_path("dances", "play_timing_config.json")
        if path.exists():
    ...
    async def __call__(self, deps: ToolDependencies, **kwargs: Any) -> dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "message_for_user": f"He hecho el baile comunitario {move_name}.",
            }
            ...
            if "collision" in lowered or "not achievable" in lowered or "ik error" in lowered:
                return {
                    ...
                    "dataset_dir": str(dataset_dir),
                    "warning": msg,
                    "mujoco_ik_warning": True,
                    "message_for_user": f"He hecho el baile comunitario {move_name}. MuJoCo ha mostrado un aviso IK, pero no lo trato como fallo si se ha visto el movimiento.",
                }
            return {
                "ok": False,
                "dance": move_name,

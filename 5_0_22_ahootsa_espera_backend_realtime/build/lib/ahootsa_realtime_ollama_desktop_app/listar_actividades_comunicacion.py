...
class ListarActividadesComunicacion(Tool):
    ...
    description = "Alias en español. Lista actividades de comunicación de nivel facil, normal o avanzada."
    ...
    async def __call__(self, deps: ToolDependencies, **kwargs: Any) -> dict[str, Any]:
        ...
        if nivel not in levels:
            ...
            result = {"ok": False, "available_levels": ["facil", "normal", "avanzada"], "alias": True}

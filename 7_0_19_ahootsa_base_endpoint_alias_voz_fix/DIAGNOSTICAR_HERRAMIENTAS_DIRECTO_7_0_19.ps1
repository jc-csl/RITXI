...
$Out = Join-Path $LogDir "AHOOTSA_DIAGNOSTICO_DIRECTO_7_0_19_$Stamp.log"
$Py = Join-Path $env:LOCALAPPDATA "Reachy Mini Control\apps_venv\Scripts\python.exe"
if (-not (Test-Path $Py)) { $Py = "python" }
Write-Host "Ahootsa diagnostico directo 7.0.19"
Write-Host "Python: $Py"
"Ahootsa diagnostico directo 7.0.19`nPython: $Py`n" | Out-File -Encoding UTF8 -FilePath $Out
$Tmp = Join-Path $env:TEMP "ahootsa_diag_direct_7_0_19.py"
@'
...
p("\n=== COMPROBACION CODIGO PATCH 7.0.19 ===")

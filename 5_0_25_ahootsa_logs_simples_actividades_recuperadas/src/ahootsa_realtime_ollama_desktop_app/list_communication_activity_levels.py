...
class ListCommunicationActivityLevels(Tool):
    ...
    description = "Ofrece los tres niveles de actividades de comunicación: fácil, intermedia o avanzada."
    needs_response = True
    ...
    async def __call__(self, deps: ToolDependencies, **kwargs: Any) -> dict[str, Any]:
        ...
        message = (
            "¿Qué tipo de actividades quieres hacer: fáciles, intermedias o avanzadas? "

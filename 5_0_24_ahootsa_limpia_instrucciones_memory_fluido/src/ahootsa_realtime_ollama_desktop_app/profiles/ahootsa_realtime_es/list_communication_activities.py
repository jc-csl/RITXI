...
def _normalize_level(value: object) -> str:
    ...
    if text in {"facil", "fácil", "sencillo", "bajo", "iniciacion", "iniciación"}:
        return "facil"
    if text in {"normal", "medio", "intermedio", "intermedia", "nivel 2", "2", "dos"}:
        return "normal"
...
class ListCommunicationActivities(Tool):
    ...
    description = "Lista al menos cinco actividades de comunicación para un nivel: facil, intermedia o avanzada."
    needs_response = True
    ...
    parameters_schema = {
        ...
        "properties": {
            "level": {
                "type": "string",
                "description": "Nivel de actividades: facil, intermedia o avanzada.",
                "enum": ["facil", "intermedia", "normal", "avanzada"],
                "default": "facil",
            },
    ...
    async def __call__(self, deps: ToolDependencies, **kwargs: Any) -> dict[str, Any]:
        ...
        if level_id not in levels:
            message = "Puedo ofrecer actividades fáciles, intermedias o avanzadas. ¿Cuál prefieres?"
            return {
                "ok": False,
                "error": "unknown_level",
                "available_levels": ["facil", "intermedia", "avanzada"],
                "message": message,
                "text": message,
                "answer": message,
                "content": message,

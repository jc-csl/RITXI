...
# v0.4.45: diagnóstico corregido sin saltos de línea dentro de rutas.
...
Write-Host "En v0.4.45 el diagnóstico ya no cuenta instructions.txt como configuración de voz."

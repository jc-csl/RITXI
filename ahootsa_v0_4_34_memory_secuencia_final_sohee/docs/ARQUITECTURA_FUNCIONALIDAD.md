...
**Versión documentada:** v0.4.34 `base_original_resources`  
**Programa:** Ahootsa Realtime Ollama  
**Entry-point Desktop:** `ahootsa_realtime_ollama_app`  
**Base estable recomendada:** v0.4.34  
...
En v0.4.34 las herramientas activas son:
...
### v0.4.34 a v0.4.34 — Performance Library experimental
...
### v0.4.34 — Original Robot Tools Recovery
...
### v0.4.34 — Original Tools Clean Start
...
## 15. Actualización v0.4.34

La versión v0.4.34 consolida esta arquitectura como base estable. La diferencia importante respecto a v0.4.34 es que `instructions.txt` queda más estricto: `ask_ollama` no se usa por defecto para preguntas generales ni para razonamiento normal; solo se usa cuando el usuario pide explícitamente IA local, Ollama, modelo local o ahootsa-local.

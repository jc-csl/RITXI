...
# Ahootsa Realtime Ollama v0.4.34
...
## v0.4.34 — Integración en Desktop
...
## v0.4.34 — Cámara PC en simulación
...
## v0.4.34 — Reparar panel integrado de Desktop
...
## v0.4.34 — Emociones con sonido y movimiento
...
## v0.4.34 — Emociones con audio sin GStreamer
...
## v0.4.34 — Juego de parejas de animales
...
## v0.4.34 — Corrección HTML del juego
...
La versión v0.4.34 instala el HTML también dentro del perfil Ahootsa.


## v0.4.34 — Motor JSON de juegos de parejas
...
## v0.4.34 — Juegos visuales simples
...
## v0.4.34 — Memory visual con ritmo del robot

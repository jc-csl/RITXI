...
function renderActiveSession(active) {
  ...
  setSessionControls(active.status === "active", Boolean(active.runtime_prepared));
...
async function finishSession() {
  try {
    ...
    $("finalSummary").innerHTML = `
      ...
      Duración: ${result.duration_minutes} min<br>

...
Write-Host " Ahootsa Realtime Ollama v0.4.10 - instalacion completa" -ForegroundColor Cyan
Write-Host "============================================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "Si estaba abierto, cierralo ahora. Continuando en 3 segundos..." -ForegroundColor Yellow

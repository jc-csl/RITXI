# v0.4.26 — Juego de parejas de animales
...
## v0.4.26 — Corrección HTML del juego
...
La versión v0.4.26 instala el HTML también dentro del perfil Ahootsa.


## v0.4.26 — Motor JSON de juegos de parejas
